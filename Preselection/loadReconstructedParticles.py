...
ma.inputMdst(environmentType='default',
             filename=b2.find_file('../Generation/RootFiles/tau_pi2munu_GEN_SIM_REC_wo_Bkg.mdst.root'),
             path=my_path)
...
ma.fillParticleList(decayString='anti-p-:good', cut='protonID > 0.1', path=my_path)
...
stdPi0s(listtype='eff40', path=my_path)
#stdKlongs(listtype='all', path=my_path)  # only 'allklm' is recommended at the moment
...
#ma.printList('pi0:eff40', False, path=my_path)
...
#ma.variablesToNtuple(decayString='pi0:eff40',
