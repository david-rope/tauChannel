...
# EvtGen
ge.add_evtgen_generator(path=my_path, finalstate=final_state, signaldecfile=dec_file)
...
# dump in MDST format
mdst.add_mdst_output(path=my_path, mc=True, filename='OutputFiles/evtgen_upsilon4s.root')
