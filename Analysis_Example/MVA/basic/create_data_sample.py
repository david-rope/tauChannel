...
def reconstruction_path(inputfiles):
    path = create_path()
    inputMdstList('default', inputfiles, path=path)
...
if __name__ == "__main__":
    ...
    f = '../../Generation/OutputFiles/evtgen_upsilon4s.root'
#    f = '../../DST_Data/mdst.physics.0010.05154.HLT0.hlt_hadron.f00000.root'
